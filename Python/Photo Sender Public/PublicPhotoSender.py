...
service_account_key_file ="INSERTFILENAME.json"
...
my_password = "INSERTPASSWORD"
 
# Drive Getting Photos-------------------------------------------
folder_id = 'INSERTFOLDERID'
...
# Email Details
from_email = 'INSERTEMAIL@gmail.com'
to_email = ''
subject = 'Daily Picture Of INSERTNAME'
