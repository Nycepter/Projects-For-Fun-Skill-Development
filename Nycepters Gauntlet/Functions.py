...
def SaveData():
    try:
        with open('C:/Users/Nycepter/Documents/GitHub/database.pkl', 'wb') as f:
            pickle.dump(db, f)
...
def LoadData():
    if os.path.exists('C:/Users/Nycepter/Documents/GitHub/database.pkl'):
        try:
            with open('C:/Users/Nycepter/Documents/GitHub/database.pkl', 'rb') as f:
...
def Hangman():
    ...
    while True:
        ...
        Word_Bank = [
            "diabolical", "speedway", "glasscannon", "javascript", "abandoning",
            "twogirlsonecup", "zebra", "computer", "elephant", "strawberry",
            "rainbow", "mountain", "sunshine", "butterfly", "waterfall",
            "chocolate", "guitar", "boulevard", "adventure", "ocean", "paradise",
            "whisper", "umbrella", "keyboard", "eclipse", "fireworks", "laughter",
            "jazz", "silhouette", "swimming", "reflection", "enchanted",
            "nightfall", "serendipity", "piano", "harmony", "journey", "breeze",
            "moonlight", "carousel", "silence", "sunset", "oasis", "champion",
            "chocolate", "fantasy", "freedom", "discovery", "captain", "treasure",
            "daydream", "champion", "mystery", "secret", "desire", "imagination",
            "butterfly", "horizon", "whisper", "eternity", "blossom", "crystal",
            "cascade", "passion", "dream", "inspiration", "cascade", "legend",
            "paradise", "island", "serenity", "reverie", "rhapsody", "infinity",
            "captivate", "marvel", "sunrise", "adventure", "jubilee", "mesmerize",
            "kaleidoscope", "infinity", "wanderlust", "harmony", "reverie",
            "lullaby", "mystical", "blissful", "fantasia", "incandescent",
            "whimsical", "effervescent", "beautiful", "captivating", "majestic",
            "graceful", "peaceful", "tranquil", "radiant", "glorious", "ecstasy",
            "elegant", "delightful", "vibrant", "enchantment", "magnificent",
            "picturesque", "charming", "picturesque", "fascination", "exquisite",
            "fanciful", "ethereal", "dazzling", "serendipity", "soothing",
            "tantalizing", "breathtaking", "sparkling", "mesmerizing",
            "resplendent", "starry", "fairy", "ballet", "symphony", "miracle",
            "carnival", "embrace", "laughter", "eternal", "freedom", "breeze",
            "victory", "passion", "lighthouse", "reflection", "celebration",
            "happiness", "celestial", "whisper", "paradise", "fantasy",
            "boulevard", "mystery", "imagination", "inspiration", "discovery",
            "chocolate", "piano", "butterfly", "horizon", "journey", "eclipse",
            "carousel", "ocean", "silhouette", "swimming", "guitar", "champion",
            "sunshine", "rainbow", "mountain", "strawberry", "elephant",
            "computer", "zebra", "tiger", "tropical", "dream", "illusion",
            "reflection", "rhapsody", "mesmerize", "enchantment", "infinite",
            "whimsy", "daydream", "sparkle", "treasure", "captivate", "luminous",
            "harmony", "serenity", "lullaby", "cascading", "fantasia", "ethereal",
            "radiance", "blissful", "majestic", "serendipity", "mesmerizing",
            "paradise", "embrace", "breathtaking", "celestial", "delightful",
            "graceful", "tranquil", "starry", "majesty", "inspiration", "rhapsody",
            "eternity", "freedom", "victory", "soothing", "captivating", "ecstasy",
            "imagination", "charming", "kaleidoscope", "carnival", "reverie",
            "magnificent", "wanderlust", "symphony", "blossom", "imagination",
            "serendipity", "lullaby", "breathtaking", "radiance", "mystical",
            "whimsical", "picturesque", "beautiful", "graceful", "vibrant",
            "dazzling", "tranquil", "enchantment", "glorious", "ecstasy",
            "charming", "mesmerizing", "fanciful", "effervescent", "fairy",
            "ballet", "celebration", "miracle", "carnival", "embrace", "laughter",
            "eternal", "freedom", "breeze", "victory", "passion", "lighthouse",
            "reflection", "eternity", "fantasy", "inspiration", "lullaby",
            "marvel", "mystical", "whimsical", "majestic", "blissful",
            "picturesque", "charming", "mesmerizing", "reverie", "ethereal",
            "incandescent", "mesmerize", "resplendent", "starry", "fairy",
            "ballet", "symphony", "miracle", "carnival", "embrace", "laughter",
            "eternal", "freedom", "breeze", "victory", "passion", "lighthouse",
            "reflection", "celebration", "happiness", "celestial", "whisper",
            "paradise", "fantasy", "boulevard", "mystery", "imagination",
            "inspiration", "discovery", "chocolate", "piano", "butterfly",
            "horizon", "journey", "eclipse", "carousel", "ocean", "silhouette",
            "swimming", "guitar", "champion", "sunshine", "rainbow", "mountain",
            "strawberry", "elephant", "computer", "zebra", "tiger", "tropical",
            "dream", "illusion", "reflection", "rhapsody", "mesmerize",
            "enchantment", "infinite", "whimsy", "daydream", "sparkle", "treasure",
            "captivate", "luminous", "harmony", "serenity", "lullaby", "cascading",
            "fantasia", "ethereal", "radiance", "blissful", "majestic",
            "serendipity", "mesmerizing", "paradise", "embrace", "breathtaking",
            "celestial", "delightful", "graceful", "tranquil", "starry", "majesty",
            "inspiration", 'abruptly', 'absurd', 'abyss', 'affix', 'askew',
            'avenue', 'awkward', 'axiom', 'azure', 'bagpipes', 'bandwagon',
            'banjo', 'bayou', 'beekeeper', 'bikini', 'blitz', 'blizzard', 'boggle',
            'bookworm', 'boxcar', 'boxful', 'buckaroo', 'buffalo', 'buffoon',
            'buxom', 'buzzard', 'buzzing', 'buzzwords', 'caliph', 'cobweb',
            'cockiness', 'croquet', 'crypt', 'curacao', 'cycle', 'daiquiri',
            'dirndl', 'disavow', 'dizzying', 'duplex', 'dwarves', 'embezzle',
            'equip', 'espionage', 'euouae', 'exodus', 'faking', 'fishhook',
            'fixable', 'fjord', 'flapjack', 'flopping', 'fluffiness', 'flyby',
            'foxglove', 'frazzled', 'frizzled', 'fuchsia', 'funny', 'gabby',
            'galaxy', 'galvanize', 'gazebo', 'giaour', 'gizmo', 'glowworm',
            'glyph', 'gnarly', 'gnostic', 'gossip', 'grogginess', 'haiku',
            'haphazard', 'hyphen', 'iatrogenic', 'icebox', 'injury', 'ivory',
            ...
            'kazoo', 'keyhole', 'khaki', 'kilobyte', 'kiosk', 'kitsch',
            'kiwifruit', 'klutz', 'knapsack', 'larynx', 'lengths', 'lucky',
            ...
            'wyvern', 'xylophone', 'yachtsman', 'yippee', 'yoked', 'youthful',
