...
def Haunted_School():
    ...
    fake_type("A thich layer of dust covers everthing, some of the desks are turned over, and there are boards covering the window on the door.")
    ...
    while True:
        ...
        while True:
            ...
            if Choice1 == "look around":
                fake_type("Walking around the room you notice a few things of interest. The teachers desk is pushed into the corner. A single locker locker lies on the back wall, it seems rather out of place. There is also backpack on the floor by the locker.")
                while True:
                    fake_type(
                    ...
                    if Choice2 == "desk":
                        ...
                        if Locker_Open == False:
                            ...
                            Choice6 = input("> ").lower()
                            clear_console()
                            if (Choice6 == "yes" and Player.Gender == "male") or (Choice6 == "yes" and Player.Gender == "female" and Has_Crowbar == True):
                                if Player.Gender == "female":
                                    Locker_Open = True
                                    fake_type('You put the crowbar in the locker and give it a good yank, the door flies open and a skeleton falls out, the bones scattering as they crash to the ground. Scratched into the paint on the inside of the locker is "I go out on my own terms, I refuse to be a part of this sick game." At the bottom of the locker you notice a gun.')

                                else:
                                    Locker_Open = True
                                    fake_type('You grab the locker and give it a good yank, the door flies open and a skeleton falls out, the bones scattering as they crash to the ground. Scratched into the paint on the inside of the locker is "I go out on my own terms, I refuse to be a part of this sick game." At the bottom of the locker you notice a gun.')
                        ...
                        while True:
                            ...
                            clear_console()
                            if Choice7 == "gun":
                                fake_type("You pick up the gun, it is a revolver that has 5 bullets in the cylinder, but the chamber is empty. You can tell that due to age, the gun by this point either no longer works, or that if it does work, it wouldn't work safetly. It is best to leave it be.")
                                continue
                ...
                fake_type("You grasp the handle and attempt to turn it, you hear a slight rattle as the knob encounters the locking mechanism. You will need to find the key to open this door.\n")
                continue
            elif Choice1 == "open the door" and Has_Door_Key == True:
                fake_type("You grasp the handle and attempt to turn it, you hear a slight rattle as the knob encounters the locking mechanism. Would you like to try the key you found?")
            ...
            while Door_open == True:
                fake_type("You open the door, the hallway lights are flickering, and the walls are covered in blood. You can hear a faint sound of a radio playing in the distance. You can also see a sign that says 'Exit' in the distance. Would you like to 'go to the exit', 'investigate the radio', or 'go back' into the room?")
                ...
                if Choice13 == "go to the exit" and Exit_Unlocked == False:
                    ...
                    while True:
                        fake_type("You walk towards the music, there is a radio sitting on a table in the middle of a room. It is an old radio, it looks like it is from the 80's. The radio is playing a song, but it is very faint. You can't quite make out what the song is. You notice that the radio is sitting next to a laptop. \nWould you like to investigate the 'laptop' or 'go back'?")
